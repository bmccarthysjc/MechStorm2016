...
public class OI {
    ...
    public OI(Robot robot) {
        ...
        */
        ...
        SmartDashboard.putNumber("Lift Encoder", RobotMap.aimscissorLift.get());
        SmartDashboard.putNumber("testing", robot.aim.getbucketposition());
        SmartDashboard.putBoolean("LimitBottom Switch", robot.aim.getlimitswitchBottom());
        SmartDashboard.putBoolean("LimitTop Switch", robot.aim.getlimitswitchTop());
